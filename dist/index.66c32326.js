...
})({"by0BM":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6c5d7bac66c32326";
"use strict";
...
},{}],"8tXhl":[function(require,module,exports,__globalThis) {
var _musicplayerJs = require("./modules/musicplayer.js");
// Select elements
...
const player = new (0, _musicplayerJs.MusicPlayer)(audioElement, playButton, nextButton, prevButton, listenNowButton, songButtons, titleElement, artistElement, coverElement, progressBar, progressContainer, currentTimeElement, durationElement);
// Add songs
player.addSongs([
    new (0, _musicplayerJs.Song)("Fight Back", "NEFFEX", "/src/audio/neffex-1.mp3", "03:20", "/src/images/song-1.png"),
    new (0, _musicplayerJs.Song)("Marilag", "Dionela ", "/src/audio/song-5.mp3", "04:26", "/src/images/song-5.png"),
    new (0, _musicplayerJs.Song)("Take A Look Around", "Limp Bizkit", "/src/audio/limpBizkit.mp3", "05:21", "/src/images/song-3.png"),
    new (0, _musicplayerJs.Song)("Pananabik", "Morebeats, H20 Klann, Prophecee", "/src/audio/pananabik.mp3", "04:26", "/src/images/song-4.png"),
    new (0, _musicplayerJs.Song)("Best Of Me", "NEFFEX", "/src/audio/neffex-2.mp3", "03:47", "/src/images/song-2.png")
]);

},{"./modules/musicplayer.js":"jLA3z"}],"jLA3z":[function(require,module,exports,__globalThis) {
...
class MusicPlayer {
    constructor(audioElement, playButton, nextButton, prevButton, listenNowButton, songButtons, titleElement, artistElement, coverElement, progressBar, progressContainer, currentTimeElement, durationElement){
    ...
    addEventListeners() {
        ...
        this.progressContainer.addEventListener("click", (event)=>this.setProgress(event));
...
},{}]},["by0BM","8tXhl"], "8tXhl", "parcelRequire94c2")

//# sourceMappingURL=index.66c32326.js.map
